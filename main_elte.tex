...
\def\mytitle{WIP:  Merkle Tree-based framework for verifiable and incentivized data contribution in privacy-preserving data contribution systems: A Proof-of-concept} % Title of thesis
...
%TODO
As identified at the of the literature review, there needs to be some protocol for the 
