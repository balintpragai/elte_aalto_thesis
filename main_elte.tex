...
\def\mytitle{Merkle Tree-based framework for verifiable, incentivized and privacy-preserving data contribution systems: A Proof-of-concept} % Title of thesis
...
\def\myacdsupentit{Associate Professor}% Title of your Academic Supervisor from your Entry University
...
\vspace*{-30pt}
\includegraphics*[scale=0.25]{logos/elte-logo.jpg}
...
\section{WibsonTree and other Merkle tree concepts}
...
\section{Possible business scenarios}\label{sec: business_scen}
...
The tree initialization and encoding looks like the following in code:
\begin{verbatim}
